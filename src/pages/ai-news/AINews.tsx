...
const newsItems = [
  ...
  },
  {
    ...
    month: '2026',
    tag: 'Model',
    title: 'Claude Fable 5 — 가장 강력한 모델',
    titleEn: 'Claude Fable 5 — Most Capable Model',
    excerpt: 'Fable 5는 최난도 추론과 장시간 자율 에이전트 작업을 위한 프리미엄 모델입니다. 1M 컨텍스트, 128K 출력을 지원하며 대규모 코드 마이그레이션과 심층 연구에 강점을 보입니다.',
    excerptEn: 'Fable 5 is the premium model for the hardest reasoning and long-horizon autonomous agents. It supports a 1M context window and 128K output, excelling at large code migrations and deep research.',
  },
  {
    date: '2026-05',
    day: 'API',
