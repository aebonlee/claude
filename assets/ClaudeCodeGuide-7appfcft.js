import{j as e,M as f,r as y}from"./markdown-Bb6HBFF6.js";import{b as v}from"./vendor-Cbm2kc8j.js";import{u as E}from"./index-BA1Mg9cu.js";import{S as b}from"./SEOHead-DfBpSINb.js";import{T as S,C as p}from"./TipBox-CSlg_9ru.js";import"./supabase-BiHzSKx7.js";import"./pdf-ckwbz45p.js";const P={id:"overview",title:"개요",titleEn:"Overview",icon:"fa-book",sections:[{title:"Claude Code란?",titleEn:"What is Claude Code?",content:`Claude Code는 Anthropic이 만든 **에이전틱 코딩 도구**로, 터미널에서 직접 실행됩니다. 코드베이스를 이해하고, 명령을 실행하며, 코드를 편집하고, 복잡한 소프트웨어 엔지니어링 작업을 자율적으로 수행할 수 있습니다.
...
npm install -g @anthropic-ai/claude-code
claude
\`\`\``}]},T={id:"cli-features",title:"CLI 기능",titleEn:"CLI Features",icon:"fa-terminal",sections:[{title:"멀티턴 대화",titleEn:"Multi-turn Conversations",content:`Claude Code는 대화형 모드에서 멀티턴 대화를 지원합니다. 이전 대화 컨텍스트를 유지하면서 연속적인 작업을 수행할 수 있습니다.
