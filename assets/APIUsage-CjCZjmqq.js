import{j as e,M as g,r as h}from"./markdown-Bb6HBFF6.js";import{b as y}from"./vendor-Cbm2kc8j.js";import{u as _}from"./index-CyMtAlro.js";import{S as f}from"./SEOHead-DfBpSINb.js";import{T as x,C as p}from"./TipBox-CSlg_9ru.js";import"./supabase-BiHzSKx7.js";import"./pdf-ckwbz45p.js";const k={id:"getting-started",title:"API 시작하기",titleEn:"Getting Started",icon:"fa-rocket",sections:[{title:"Anthropic API 소개",titleEn:"Introduction to the Anthropic API",content:`Anthropic API를 사용하면 Claude 모델을 자신의 애플리케이션에 직접 통합할 수 있습니다. 대화형 AI, 콘텐츠 생성, 코드 작성, 데이터 분석 등 다양한 기능을 프로그래밍 방식으로 활용할 수 있습니다.
...
| 모델 | 모델 ID | 특징 | 용도 |
|------|---------|------|------|
| **Claude Fable 5** | claude-fable-5 | 가장 강력, 최난도 추론·장기 에이전트 | 대규모 마이그레이션, 심층 연구, 자율 에이전트 |
| **Claude Opus 4.8** | claude-opus-4-8 | 최고 성능의 Opus, 복잡한 추론 | 연구, 복잡한 코딩, 전략 |
| **Claude Sonnet 4.6** | claude-sonnet-4-6 | 속도와 지능의 균형 | 범용, 코드 생성, 분석 |
| **Claude Haiku 4.5** | claude-haiku-4-5 | 빠른 응답, 저비용 | 분류, 요약, 간단한 질의 |

### 모델 선택 가이드

- **Fable 5**: 가장 어려운 추론, 장시간 자율 에이전트, 대규모 마이그레이션이 필요할 때
...
Opus 4.8, Sonnet 4.6, Fable 5는 **1M(100만 토큰)** 컨텍스트 윈도우를 표준 가격으로 지원합니다(약 2,500페이지 분량). Haiku 4.5는 200K 토큰을 지원합니다.
...
|-------|----------|----------------|-----------|
| **Claude Fable 5** | claude-fable-5 | Most capable, hardest reasoning & long-horizon agents | Large migrations, deep research, autonomous agents |
| **Claude Opus 4.8** | claude-opus-4-8 | Top-performing Opus, complex reasoning | Research, complex coding, strategy |
| **Claude Sonnet 4.6** | claude-sonnet-4-6 | Balance of speed and intelligence | General purpose, code generation, analysis |
| **Claude Haiku 4.5** | claude-haiku-4-5 | Fast responses, low cost | Classification, summarization, simple queries |

### Model Selection Guide

- **Fable 5**: When you need the hardest reasoning, long-horizon autonomous agents, or large migrations
...
Opus 4.8, Sonnet 4.6, and Fable 5 support a **1M (1 million token)** context window at standard pricing (~2,500 pages). Haiku 4.5 supports 200K tokens.
...
\`\`\``}]},P={id:"tool-use-api",title:"Tool Use API",titleEn:"Tool Use API",icon:"fa-wrench",sections:[{title:"Tool Use 구현",titleEn:"Implementing Tool Use",content:`Tool Use를 사용하면 Claude가 사전 정의된 도구(함수)를 호출하여 외부 시스템과 상호작용할 수 있습니다.
...
- 동일한 프리픽스를 반복 요청하면 두 번째 요청부터 캐시 읽기로 비용 절감`,contentEn:`The Anthropic API charges on a pay-per-use basis based on tokens. Input and output tokens are priced differently, and pricing varies by model.
...
- Repeating the same prefix lets the second and later requests read from cache`},{title:"비용 최적화 전략",titleEn:"Cost Optimization Strategies",content:`### 1. 적절한 모델 선택
...
> **Note**: Both the Python and TypeScript SDKs support the same API features, so choose the SDK that matches your project's technology stack.`}]},l=[k,A,b,P,S,v,I];function D(){const{language:m}=_(),s=m==="ko",[n,r]=y.useState(0),i=l[n],u={code({inline:t,className:o,children:a,...d}){const c=/language-(\w+)/.exec(o||"");return!t&&c?e.jsx(p,{code:String(a).replace(/\n$/,""),language:c[1]}):!t&&!c&&String(a).includes(`
`)?e.jsx(p,{code:String(a).replace(/\n$/,""),language:""}):e.jsx("code",{className:"inline-code",...d,children:a})},table({children:t}){return e.jsx("div",{className:"table-responsive",children:e.jsx("table",{children:t})})},blockquote({children:t}){return e.jsx(x,{type:"tip",children:t})}};return e.jsxs("div",{className:"guide-page",children:[e.jsx(f,{title:s?"API 활용 가이드":"API Usage Guide",path:"/api-usage"}),e.jsxs("div",{className:"guide-layout",children:[e.jsxs("aside",{className:"guide-sidebar",children:[e.jsx("div",{className:"guide-sidebar-title",children:s?"목차":"Contents"}),e.jsx("ul",{className:"guide-nav",children:l.map((t,o)=>e.jsx("li",{className:"guide-nav-item",children:e.jsxs("button",{className:`guide-nav-link ${o===n?"active":""}`,onClick:()=>r(o),children:[e.jsx("i",{className:`fa-solid ${t.icon} nav-icon`}),s?t.title:t.titleEn]})},t.id))})]}),e.jsxs("div",{className:"guide-content",children:[e.jsx("div",{className:"guide-content-header",children:e.jsx("h1",{children:s?i.title:i.titleEn})}),i.sections.map((t,o)=>e.jsxs("div",{className:"guide-section",children:[e.jsx("h2",{children:s?t.title:t.titleEn}),e.jsx("div",{className:"markdown-body",children:e.jsx(g,{remarkPlugins:[h],components:u,children:s?t.content:t.contentEn})})]},o)),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{disabled:n===0,onClick:()=>r(n-1),children:[e.jsx("i",{className:"fa-solid fa-chevron-left"})," ",s?"이전":"Previous"]}),e.jsxs("button",{disabled:n===l.length-1,onClick:()=>r(n+1),children:[s?"다음":"Next"," ",e.jsx("i",{className:"fa-solid fa-chevron-right"})]})]})]})]})]})}export{D as default};
