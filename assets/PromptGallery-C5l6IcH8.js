import{j as n}from"./markdown-Bb6HBFF6.js";import{b as i}from"./vendor-Cbm2kc8j.js";import{u as f}from"./index-DQNYRqIn.js";import{S as E}from"./SEOHead-DfBpSINb.js";import"./supabase-BiHzSKx7.js";import"./pdf-ckwbz45p.js";const l=[{key:"all",label:"전체",labelEn:"All"},{key:"coding",label:"코딩",labelEn:"Coding"},{key:"writing",label:"글쓰기",labelEn:"Writing"},{key:"analysis",label:"분석",labelEn:"Analysis"},{key:"creative",label:"크리에이티브",labelEn:"Creative"},{key:"business",label:"비즈니스",labelEn:"Business"}],d=[{category:"coding",title:"코드 리뷰 요청",titleEn:"Code Review Request",desc:"코드의 품질, 보안, 성능을 종합적으로 리뷰합니다.",descEn:"Comprehensively review code for quality, security, and performance.",prompt:`다음 코드를 리뷰해주세요. 아래 관점에서 분석해주세요:
1. 코드 품질 및 가독성
2. 잠재적 버그
3. 보안 취약점
4. 성능 개선점
